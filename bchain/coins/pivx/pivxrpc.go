...
func (z *PivXRPC) Initialize() error {
	...
	z.Parser = NewPivXParser(params, z.ChainConfig)
...
func (z *PivXRPC) GetChainInfo() (*bchain.ChainInfo, error) {
...
func (z *PivXRPC) GetTransactionForMempool(txid string) (*bchain.Tx, error) {
	return z.GetTransaction(txid)
}

func (p *PivXRPC) GetTransaction(txid string) (*bchain.Tx, error) {
	r, err := p.BitcoinRPC.GetTransaction(txid)
	if err != nil {
		return nil, err
	}
	// TODO: Do something with this
	r.CoinSpecificData = 2
	return r, nil
}

// GetMempoolEntry returns mempool data for given transaction
func (z *PivXRPC) GetMempoolEntry(txid string) (*bchain.MempoolEntry, error) {
	return nil, errors.New("GetMempoolEntry: not implemented")
}

// GetBlockRaw is not supported
func (z *PivXRPC) GetBlockRaw(hash string) (string, error) {
